"""
Based on https://github.com/openai/gpt-2/blob/master/src/sample.py
...
def sample_sequence(
        *, hparams, length, start_token=None, batch_size=None, context=None,
    ...
    with tf.name_scope('sample_sequence'):
        ...
        # TODO: Would be slightly faster if we called step on the entire
        # context, rather than leaving the last token transformer calculation
        # to the while loop.
